        ...
        >
            <div style="padding: 20px; background-color:white">
                <div class="container-fluid">
                    <p><strong>Edit {{stockOrPrice}}</strong></p>
            ...
            <form>
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        <button class="btn btn-default ml-3" type="button" style="border-color: silver;">cari</button>
                    </div>
                </div>
            </form>
            ...
            >
                <template #cell(stok)="data">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-default btn-sm editBtn"
                                    type="button"
                                    @click="() => {showModal(0, data.index)}"
                            >edit</button>
                        </div>
                    </div>
                </template>
